...
class AnswersApi {
  ...
  ///
  ///
  Future<ReadAnswer> answersCreate(String questionId,
      {CreateAnswer body}) async {
    ...
    String path = "/questions/{questionId}/answers"
    ...
    if (response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'ReadAnswer') as ReadAnswer;
    } else {
      return null;
    }
  }
  ...
  ///
  ///
  Future<ReadUpVotes> answersCreateUpVoteAnswer(
    ...
    // create path and map variables
    String path = "/questions/{questionId}/answers/{answerId}/upvote"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "questionId" + "}", questionId.toString())
  ...
  Future answersDelete(String questionId, String answerId) async {
    ...
    // create path and map variables
    String path = "/questions/{questionId}/answers/{answerId}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "questionId" + "}", questionId.toString())
        .replaceAll("{" + "answerId" + "}", answerId.toString());
  ...
  ///
  ///
  Future<ReadUpVotes> answersDeleteUpVoteAnswer(
      String questionId, String answerId) async {
    Object postBody = null;
  ...
  ///
  ///
  Future<ReadAnswer> answersPut(String questionId, String answerId,
      {UpdateAnswer body}) async {
    Object postBody = body;
