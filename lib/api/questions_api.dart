...
class QuestionsApi {
  ...
  Future<ReadBookmarks> questionsBookmarkQuestion(String questionId) async {
    ...
    String path = "/questions/{questionId}/bookmark".replaceAll("{format}","json").replaceAll("{" + "questionId" + "}", questionId.toString());
  ...
  Future<ReadQuestion> questionsCreate({ CreateQuestion body }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'ReadQuestion') as ReadQuestion ;
    } else {
      return null;
    }
  }
  ...
  Future<ReadUpVotes> questionsCreateUpVote(String questionId) async {
    ...
    // create path and map variables
    String path = "/questions/{questionId}/upvote".replaceAll("{format}","json").replaceAll("{" + "questionId" + "}", questionId.toString());
  ...
  Future questionsDelete(String questionId) async {
    ...
    // create path and map variables
    String path = "/questions/{questionId}".replaceAll("{format}","json").replaceAll("{" + "questionId" + "}", questionId.toString());
  ...
  Future questionsDeleteVerificationForAnswer(String questionId) async {
    ...
    // create path and map variables
    String path = "/questions/{questionId}/verified-answer".replaceAll("{format}","json").replaceAll("{" + "questionId" + "}", questionId.toString());
  ...
  ///
  /// 
  Future<List<ReadQuestion>> questionsGet({ List<String> tags, String search, String filterType, String sortType }) async {
    Object postBody = null;
    ...
    if(filterType != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "filterType", filterType));
    }
    if(sortType != null) {
  ...
  Future<List<ReadQuestion>> questionsGetBookMarkedQuestions() async {
    ...
    // create path and map variables
    String path = "/questions/bookmarks".replaceAll("{format}","json");
  ...
  ///
  /// 
  Future<List<ReadQuestion>> questionsGetUserQuestions(String userId) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/questions/user/{userId}".replaceAll("{format}","json").replaceAll("{" + "userId" + "}", userId.toString());
  ...
  ///
  /// 
  Future<ReadQuestion> questionsUpdate(String questionId, { UpdateQuestion body }) async {
    Object postBody = body;
  ...
  ///
  /// 
  Future<ReadVerifiedAnswer> questionsVerifyAnswer(String questionId, String answerId) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/questions/{questionId}/verified-answer/{answerId}".replaceAll("{format}","json").replaceAll("{" + "questionId" + "}", questionId.toString()).replaceAll("{" + "answerId" + "}", answerId.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'ReadVerifiedAnswer') as ReadVerifiedAnswer ;
    } else {
      return null;
    }
  }
