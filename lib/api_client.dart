  ...
  dynamic _deserialize(dynamic value, String targetType) {
    try {
      switch (targetType) {
        ...
        case 'CreateAnswer':
          return new CreateAnswer.fromJson(value);
        case 'CreateComment':
        ...
        case 'ReadBookmarks':
          return new ReadBookmarks.fromJson(value);
        case 'ReadComment':
          return new ReadComment.fromJson(value);
        case 'ReadQuestion':
          return new ReadQuestion.fromJson(value);
        case 'ReadTag':
          return new ReadTag.fromJson(value);
        case 'ReadUpVotes':
          return new ReadUpVotes.fromJson(value);
        case 'ReadUser':
          return new ReadUser.fromJson(value);
        case 'ReadUserBackendData':
          return new ReadUserBackendData.fromJson(value);
        case 'ReadVerifiedAnswer':
          return new ReadVerifiedAnswer.fromJson(value);
        case 'UpdateAnswer':
          return new UpdateAnswer.fromJson(value);
        case 'UpdateComment':
          return new UpdateComment.fromJson(value);
        case 'UpdateQuestion':
          return new UpdateQuestion.fromJson(value);
        default:
          {
            Match match;
            if (value is List &&
