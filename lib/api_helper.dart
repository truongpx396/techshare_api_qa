...
String parameterToString(dynamic value) {
  ...
  } else if (value is QuestionFilterType) {
    return QuestionFilterType.encode(value).toString();
  } else if (value is QuestionSortType) {
    return QuestionSortType.encode(value).toString();
  } else {
