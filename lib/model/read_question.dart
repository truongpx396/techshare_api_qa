...
class ReadQuestion {
  ...
  ReadQuestion.fromJson(Map<String, dynamic> json) {
    ...
    verifiedAnswer = json['verifiedAnswer'];
    tags = ReadTag.listFromJson(json['tags']);
    answers = ReadAnswer.listFromJson(json['answers']);
    comments = ReadComment.listFromJson(json['comments']);
    upVotes = new ReadUpVotes.fromJson(json['upVotes']);
    bookmarks = new ReadBookmarks.fromJson(json['bookmarks']);
  }
  ...
  static List<ReadQuestion> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<ReadQuestion>()
        : json.map((value) => new ReadQuestion.fromJson(value)).toList();
  }

  static Map<String, ReadQuestion> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, ReadQuestion>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new ReadQuestion.fromJson(value));
    }
    return map;
  }
}
